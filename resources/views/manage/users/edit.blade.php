      ...
      <div class="column">
        ...
        <div class="field">
          ...
          <div class="field">
            ...
            <p class="control">
              <input type="password" class="input" name="password" id="password" v-if="password_options == 'manual'" placeholder="Manually give a password to this user" value="{{$user->password}}">
            </p>
          </div>
        </div>
      </div> <!-- end of .column -->
