...
<div class="flex-container ">
  <div class="columns ">
    <div class="column">
      <h1 class="title">Create New Permissions</h1>
    </div>
    <hr class="m-t-0">
  </div>
  <div class="columns ">
    <div class="column">
      <form action="{{ route('permissions.store') }}" method="POST">
        ...
        <div class="block">
          ...
          <b-radio v-model="permissionType" name="permission_type" native-value="crud">CRUD Permissions</b-radio>
        </div>
        <div class="field" v-if="permissionType == 'basic'">
          <label for="name" class="label">Slug-Name</label>
          <p class="control">
        ...
        <div class="field" v-if="permissionType == 'crud'">
          <label for="description" class="label">Resource</label>
          <p class="control">
        ...
        <div class="columns" v-if="permissionType == 'crud'">
          ...
          <input type="hidden" name="crud_selected" :value="crudSelectedd">
        ...
        <button class="button is-success">Create Permissions</button>
      </form>
    </div>
  </div>
